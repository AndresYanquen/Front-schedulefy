<template>
    <fwb-footer class="bg-black-dark" footer-type="socialmedia">
      <div class="md:flex md:justify-between">
        <div class="flex w-[200px] justify-evenly my-10 items-center">
            <img src="/icons/schedulefyLogo.svg" alt=''>
            <fwb-heading class="justify-between text-[white] text-2xl" tag="h1">Schedulefy</fwb-heading>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 class="text-white mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
              Resources
            </h2>
            <fwb-footer-link-group class="flex flex-col items-start">
              ...
              <fwb-footer-link class="mb-4" link="#serv">
                Servicios
              </fwb-footer-link>
            </fwb-footer-link-group>
          </div>
          <div>
            <h2 class=" text-white mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">
              Follow us
            </h2>
            <fwb-footer-link-group class="flex flex-col items-start">
              <fwb-footer-link class="mb-4" href="https://github.com/AndresYanquen">
                GitHub
              </fwb-footer-link>
            </fwb-footer-link-group>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <fwb-footer-copyright by="Schedulefy" href="/" />
